...
<div id="fade" onClick="lightbox_close();"></div>
  ...
  <div class="row">
    <div class="col-sm icon1">
      <div class="dborder shadow pop" onclick="direc();">
          <a href="#" onclick="lightbox_open();" id="peli1"><img src="/img/mov1.jpg" alt="Responsive image" class="responsive"></a>
        </div>
    </div>
